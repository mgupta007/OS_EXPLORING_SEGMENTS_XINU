...
struct	pentry	{
	...
	int	pwaitret;
        ...
        int  call[28];                  /* Array created by me (Mohit Gupta) to track count of system calls of processes */
        int  flag;                      /*flag is created by me (Mohit)*/
        long time[28];                  /* time array created by me (Mohit) to keep track of time for system call*/    
